...
@section('content')
           ...
           <li class=""><a href="admin/qladmin/danh-sach-kichthuoc"><i class="fa  fa-sort-alpha-desc"></i> <span>Quản lí kích thước</span></a></li>
             <li class=""><a href="admin/qladmin/danh-sach-loaihang"><i class="fa fa-tags"></i> <span>Quản lí loại hàng</span></a></li>
               <li class=""><a href="admin/qladmin/danh-sach-mausac"><i class="fa fa-industry"></i> <span>Quản lí màu sắc</span></a></li>
                 <li class="active"><a href="admin/qladmin/danh-sach-nhasanxuat"><i class="fa fa-cubes"></i> <span>Quản lí nhà sản xuất</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Quản lí nhà sản xuất</a></li>
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            <tbody class="table-data">
              ...
              @foreach($nhasanxuat as $ad)
              <tr>
                <td>{{$ad->MaNSX}}</td>
                <td>{{$ad->TenNSX}}</td>
                <td> <a data-toggle="modal" data-target="#modal-default-edit" id-edit="{{$ad->MaNSX}}"  class="btn btn-app btn-edit-admin-modal eid-edit-{{$ad->MaNSX}}" style="float: left; border-radius: 3px; position: relative; padding: 0px 0px; min-width: 20px; height: 20px; text-align: center; color: #666; border: none; background-color: #00000000; font-size: 12px;margin: 0;"><i style=" float: left;color: #ff8f00; " class="fa fa-edit"></i></a>
                 <a id-del="{{$ad->MaNSX}}" data-toggle="modal" data-target="#modal-default-del" class="btn btn-app btn-del-admin-modal eid-del-{{$ad->MaNSX}}" style="float: left; border-radius: 3px; position: relative; padding: 0px 0px; min-width: 20px; height: 20px; text-align: center; color: #666;border: none; background-color: #00000000; font-size: 12px;margin-left: 11px;margin: 0px 0px 0px 10px;"><i style=" float: left;color: red; " class="fa fa-ban"></i></a></td>
              </tr>
              @endforeach
            </tbody>
          </table>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="POST" action="admin/qladmin/them-nhasanxuat">
         <div class="box-body">
    <div class="form-group">
      <input  type="hidden" name="_token" value="{{csrf_token()}}">
      <label for="TenNSX">Tên nhà sản xuất</label>
      <input name="TenNSX" type="text" class="form-control" id="TenNSX" placeholder="Nhập tên nhà sản xuất">
      </div>
          </div>
          <!-- /.box-body -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="POST" method="POST" action="admin/qladmin/sua-nhasanxuat">
         <div class="box-body">
    <div class="form-group">
      <input  type="hidden" name="_token" value="{{csrf_token()}}">
      <input  type="hidden" name="eMaNSX" value="" id="eMaNSX">
      <label for="eTenNSX">Tên nhà sản xuất</label>
      <input name="eTenNSX" type="text" class="form-control" id="eTenNSX" placeholder="Nhập tên nhà sản xuất">
      </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var a= [];
       ...
       $.ajax({
                    type: 'POST',
                    url: 'admin/qladmin/them-nhasanxuat',
                    data: JSON.stringify({TenNSX: $('#TenNSX').val() }),
                    ...
                    success: function (msg,data) {
                      ...
                      $('.table-data').html($('.table-data').html()+'<tr> <td>'+a[0][1]+'</td> <td>'+a[0][0]+'</td> <td> <a id-edit="'+a[0][1]+'" data-toggle="modal" data-target="#modal-default-edit" class="btn btn-app btn-edit-admin-modal eid-edit-'+a[0][1]+'" style="float: left; border-radius: 3px; position: relative; padding: 0px 0px; min-width: 20px; height: 20px; text-align: center; color: #666; border: none; background-color: #00000000; font-size: 12px;margin: 0;"><i style=" float: left;color: #ff8f00; " class="fa fa-edit"></i></a> <a data-toggle="modal" data-target="#modal-default-del" id-del="'+a[0][1]+'" class="btn btn-app btn btn-app btn-del-admin-modal eid-del-'+a[0][1]+'" style="float: left; border-radius: 3px; position: relative; padding: 0px 0px; min-width: 20px; height: 20px; text-align: center; color: #666;border: none; background-color: #00000000; font-size: 12px;margin-left: 11px;margin: 0px 0px 0px 10px;"><i style=" float: left;color: red; " class="fa fa-ban"></i></a></td> </tr>');
...
// code xử lí sửa
  $("#btn-edit-admin").click(function(){
    ...
    var a= [];
       ...
       $.ajax({
                    type: 'POST',
                    url: 'admin/qladmin/sua-nhasanxuat',
                    data: JSON.stringify({eMaNSX: $('#eMaNSX').val() , eTenNSX: $('#eTenNSX').val(),}),
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg,data) {
                         ...
                         // $('.eid-edit-'+ $('#eIdAdmin').val()).parent().parent().children().eq(3).val($('#eHoTenAdmin'));
                          $('.eid-edit-'+ $('#eMaNSX').val()).parent().parent().children().eq(1).html($('#eTenNSX').val());
 ...
 $("#btn-del-admin").click(function(){
    ...
    var a= [];
       ...
       $.ajax({
                    ...
                    type: 'POST',
                    url: 'admin/qladmin/xoa-nhasanxuat',
                    data: JSON.stringify({MaNSX: idclickdel}),
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg,data) {
                          console.log(idclickdel);
