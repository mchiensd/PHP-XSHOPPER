...
@section('content')
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="admin/qladmin/danh-sach-admin"><i class="fa fa-user-secret"></i> <span>Quản lí admin</span></a></li>
         <li class=""><a href="admin/qladmin/danh-sach-chude"><i class="fa fa-barcode"></i> <span>Quản lí chủ đề</span></a></li>
           <li class="active"><a href="admin/qladmin/danh-sach-kichthuoc"><i class="fa  fa-sort-alpha-desc"></i> <span>Quản lí kích thước</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Quản lí kích thước</a></li>
        <li class="active">Danh sách kích thước</li>
      </ol>
    </section>
  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">Danh sách kích thước</h3>
        <div class="box-tools">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            <tbody class="table-data">
              ...
              @foreach($kichthuoc as $ad)
              <tr>
                <td>{{$ad->MaKichThuoc}}</td>
                <td>{{$ad->TenKichThuoc}}</td>
                <td>{{$ad->Mota}}</td>
                <td> <a data-toggle="modal" data-target="#modal-default-edit" id-edit="{{$ad->MaKichThuoc}}"  class="btn btn-app btn-edit-admin-modal eid-edit-{{$ad->MaKichThuoc}}" style="float: left; border-radius: 3px; position: relative; padding: 0px 0px; min-width: 20px; height: 20px; text-align: center; color: #666; border: none; background-color: #00000000; font-size: 12px;margin: 0;"><i style=" float: left;color: #ff8f00; " class="fa fa-edit"></i></a>
                 <a id-del="{{$ad->MaKichThuoc}}" data-toggle="modal" data-target="#modal-default-del" class="btn btn-app btn-del-admin-modal eid-del-{{$ad->MaKichThuoc}}" style="float: left; border-radius: 3px; position: relative; padding: 0px 0px; min-width: 20px; height: 20px; text-align: center; color: #666;border: none; background-color: #00000000; font-size: 12px;margin-left: 11px;margin: 0px 0px 0px 10px;"><i style=" float: left;color: red; " class="fa fa-ban"></i></a></td>
              </tr>
              @endforeach
            </tbody>
          </table>
  ...
  <div class="modal fade" id="modal-default-add" style="display: none;">
    ...
    <div class="form-group">
      ...
      <input name="TenKichThuoc" type="text" class="form-control" id="TenKichThuoc" placeholder="Nhập tên kích thước">
      </div>

      <div class="form-group">    
      <label for="Mota">Mô tả kích thước</label>
      <input name="Mota" type="text" class="form-control" id="Mota" placeholder="Nhập mô tả kích thước">
      </div>
          </div>
          <!-- /.box-body -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="POST" method="POST" action="admin/qladmin/sua-chude">
         <div class="box-body">
    <div class="form-group">
      <input  type="hidden" name="_token" value="{{csrf_token()}}">
      <input  type="hidden" name="eMaKichThuoc" value="" id="eMaKichThuoc">
      <label for="eTenKichThuoc">Tên kích thước</label>
      <input name="eTenKichThuoc" type="text" class="form-control" id="eTenKichThuoc" placeholder="Nhập tên kích thước">
     
      </div>
      <div class="form-group">
      <label for="eMota">Mô tả</label>
      <input name="eMota" type="text" class="form-control" id="eMota" placeholder="Nhập mô tả kích thước">
      </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var a= [];
       ...
       $.ajax({
                    type: 'POST',
                    url: 'admin/qladmin/them-kichthuoc',
                    data: JSON.stringify({TenKichThuoc: $('#TenKichThuoc').val(),Mota: $('#Mota').val() }),
                    ...
                    success: function (msg,data) {
                      ...
                      $('.table-data').html($('.table-data').html()+'<tr> <td>'+a[0][0]+'</td> <td>'+a[0][1]+'</td> <td>'+a[0][2]+'</td> <td> <a id-edit="'+a[0][0]+'" data-toggle="modal" data-target="#modal-default-edit" class="btn btn-app btn-edit-admin-modal eid-edit-'+a[0][0]+'" style="float: left; border-radius: 3px; position: relative; padding: 0px 0px; min-width: 20px; height: 20px; text-align: center; color: #666; border: none; background-color: #00000000; font-size: 12px;margin: 0;"><i style=" float: left;color: #ff8f00; " class="fa fa-edit"></i></a> <a data-toggle="modal" data-target="#modal-default-del" id-del="'+a[0][0]+'" class="btn btn-app btn btn-app btn-del-admin-modal eid-del-'+a[0][0]+'" style="float: left; border-radius: 3px; position: relative; padding: 0px 0px; min-width: 20px; height: 20px; text-align: center; color: #666;border: none; background-color: #00000000; font-size: 12px;margin-left: 11px;margin: 0px 0px 0px 10px;"><i style=" float: left;color: red; " class="fa fa-ban"></i></a></td> </tr>');
...
// code xử lí sửa
  $("#btn-edit-admin").click(function(){
    ...
    var a= [];
       ...
       $.ajax({
                    type: 'POST',
                    url: 'admin/qladmin/sua-kichthuoc',
                    data: JSON.stringify({eMaKichThuoc: $('#eMaKichThuoc').val() , eTenKichThuoc: $('#eTenKichThuoc').val(),eMota: $('#eMota').val(),}),
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg,data) {
                         ...
                         // $('.eid-edit-'+ $('#eIdAdmin').val()).parent().parent().children().eq(3).val($('#eHoTenAdmin'));
                          console.log($('.eid-edit-'+ $('#eMaKichThuoc').val()).parent().parent().children().eq(1).html($('#eTenKichThuoc').val()));
                           console.log($('.eid-edit-'+ $('#eMaKichThuoc').val()).parent().parent().children().eq(2).html($('#eMota').val()));
 ...
 $("#btn-del-admin").click(function(){
    ...
    var a= [];
       ...
       $.ajax({
                    ...
                    type: 'POST',
                    url: 'admin/qladmin/xoa-kichthuoc',
                    data: JSON.stringify({MaKichThuoc: idclickdel}),
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg,data) {
                          console.log(idclickdel);
